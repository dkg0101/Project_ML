...
class Configuration:
    ...
    def get_model_trainer_config(self)->ModelTrainerConfig:
            try:
                ...
                model_config_file_path = os.path.join(ROOT_DIR,model_trainer_config_info[MODEL_TRAINER_MODEL_CONFIG_DIR_KEY],
    ...
    def get_model_evaluation_config(self)-> ModelEvaluationConfig:
        try:
            ...
            model_evaluation_config=ModelEvaluationConfig(model_evaluaion_file_path=model_evaluation_file_path,
