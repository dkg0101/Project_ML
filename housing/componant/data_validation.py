...
class DataValidation:
    ...
    def get_train_test_df(self):
        ...
        try:
            logging.info("getting training and testing dataframe")
    ...
    def is_train_test_file_exist(self):
        try:
            logging.info("Checking if training and test file is avialable...")
            ...
            if not is_available:
                ...
                message = f"""Training file: {train_path} or Testing file: {test_path}
                            is not present! """
    ...
    def validate_dataset_schema(self)-> bool:
        try:
            ...
            #implement validate training and testing using schema file 
